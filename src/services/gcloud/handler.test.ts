...
// Mock node:fs with a custom object we can control per test
const mockFs = {
...
describe('GcloudHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new GcloudHandler(mockFs);
  ...
  describe('Environment Configuration', () => {
    ...
    test('should use isolated environment by default', async () => {
      ...
      mockFs.existsSync.mockReturnValue(true); // Pretend local binary exists
